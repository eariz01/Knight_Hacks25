...
You must make sure the "litigation_phase" field is filled with one of these four options: ["Discovery", "Settlement Discussion", "Pre-Trial", "Trial"]. If the status is not explicitly stated in the text, default to "Pending".
